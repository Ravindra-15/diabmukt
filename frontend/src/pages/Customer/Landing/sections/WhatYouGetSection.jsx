...
const ChipCard = ({ benefit, isActive = false }) => {
  ...
  return (
    <div
      className={`bg-white border border-[#E7EAF3] rounded-2xl shadow-[0_8px_24px_rgba(16,24,40,0.08)] px-6 py-7 w-[250px] h-[230px] flex flex-col items-center justify-center text-center transition-all duration-300 ${
        isActive
      ...
      <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="text-[#6B7280] text-xs sm:text-sm italic">
            "Lets List out the Benefits of the Diabmukt Program"
          </p>
        </div>
