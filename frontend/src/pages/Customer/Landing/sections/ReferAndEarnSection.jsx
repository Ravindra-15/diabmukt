        ...
        <div className="relative overflow-hidden bg-[#F6F8FC] rounded-3xl border border-[#E7EAF3] px-6 sm:px-12 py-10 sm:py-14 mb-10">
          ...
          <div className="relative z-10 mt-10 sm:mt-12 text-center">
            <button
              ...
              className="bg-[#4F46E5] hover:bg-[#4338CA] text-white text-sm sm:text-base font-semibold px-10 sm:px-14 py-3 rounded-full shadow-[0_4px_14px_rgba(249,115,22,0.35)] transition-colors"
            >
              Learn More !
            </button>
          </div>
