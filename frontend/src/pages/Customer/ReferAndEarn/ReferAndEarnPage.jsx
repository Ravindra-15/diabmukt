    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 w-full">
        <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-12 py-8 sm:py-10">
          ...
          {/* ============================================ */}
          <div className="bg-white rounded-3xl border border-[#E7EAF3] shadow-[0_8px_30px_rgba(32,24,80,0.2)] px-6 sm:px-10 py-10 sm:py-12 mb-10">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="flex flex-col sm:flex-row items-stretch gap-3">
                ...
                <button
                  onClick={handleCopy}
                  className="inline-flex items-center justify-center gap-2 px-7 py-4 bg-[#4F46E5] hover:bg-[#4F46E5] text-white text-sm font-semibold rounded-full shadow-[0_4px_14px_rgba(91,79,247,0.3)] transition-colors whitespace-nowrap"
                >
                  {copied ? (
                    <>
                      <Check size={15} />
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 sm:px-6 sm:py-4 bg-[#4F46E5] hover:bg-[#4F46E5] text-white text-sm sm:text-xl font-semibold rounded-full shadow-[0_4px_14px_rgba(91,79,247,0.3)] transition-colors"
              >
...
const ProgressCard = ({ icon: Icon, label, value, highlight, footer }) => {
  if (highlight) {
    return (
      <div className="bg-gradient-to-br from-[#6366F1]to-[#4F46E5] rounded-2xl p-8 sm:p-10 text-white shadow-[0_8px_30px_rgba(91,79,247,0.25)] flex flex-col items-center justify-center min-h-[300px]">
