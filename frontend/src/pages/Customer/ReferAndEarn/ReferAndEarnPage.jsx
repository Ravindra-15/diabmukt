    ...
    <div className="min-h-screen bg-[#F6F8FC] flex flex-col">
      ...
      {showLimitModal && (
        ...
        >
          ...
          >
            <div className="w-14 h-14 rounded-full bg-[#F5F7FF] flex items-center justify-center mx-auto mb-4">
              <Trophy size={22} className="text-[#5B4FF7]" />
            </div>
            ...
            <button
              onClick={() => setShowLimitModal(false)}
              className="w-full px-6 py-3 bg-[#5B4FF7] hover:bg-[#4338CA] text-white text-sm font-semibold rounded-full shadow-[0_4px_14px_rgba(91,79,247,0.3)] transition-colors"
            >
              Got it
            </button>
          </div>
