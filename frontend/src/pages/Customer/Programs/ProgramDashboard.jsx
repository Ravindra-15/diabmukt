  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // // 🔔 show expiry popup if active plan ends within 7 days and no renewal queued
        // if (
        //   sub?.isActive &&
    ...
    <div className="min-h-screen bg-[#F6F8FC] flex flex-col">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md px-7 py-8 text-center relative">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-6 py-2.5 rounded-full text-sm font-semibold text-white bg-[#5B4FF7] hover:bg-[#4338CA] transition-colors"
            >
              Renew Now
            </button>
          </div>
      ...
      <style>{`
        @keyframes consultBlink {
          0%, 100% { border-color: #C7C2F5; box-shadow: 0 0 0 0 rgba(91,79,247,0); }
          50% { border-color: #5B4FF7; box-shadow: 0 0 0 4px rgba(91,79,247,0.15); }
        }
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-5">
          ...
          <div
            ref={topRef}
            className="bg-white rounded-[28px] border border-[#E7EAF3] shadow-[0_10px_30px_rgba(15,23,42,0.05)] px-6 py-7 sm:px-8"
          >
          ...
          {(() => {
            ...
            return (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-stretch">
                {/* ── LEFT: Video Card ───────────────────────── */}
                <div className="bg-white rounded-[28px] border border-[#E7EAF3] shadow-[0_10px_30px_rgba(15,23,42,0.05)] p-5 sm:p-6 flex flex-col">
                  {loadingVideo ? (
                          ...
                          <button
                            ...
                            className={`inline-flex items-center gap-2 text-sm font-semibold px-8 py-2.5 rounded-full transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-70 ${
                              completedToday
                                ...
                                : "bg-[#5B4FF7] hover:bg-[#4338CA] text-white shadow-[0_8px_20px_rgba(91,79,247,0.22)]"
                            }`}
                          >
                            <Play
                              size={13}
                ...
                <div className="hidden lg:flex flex-col justify-between relative overflow-hidden rounded-[28px] p-8 text-white bg-gradient-to-br from-[#5B4FF7] to-[#4338CA] shadow-[0_10px_30px_rgba(91,79,247,0.25)]">
                  {/* decorative circles */}
          ...
          {/* <div className="bg-white rounded-[28px] border border-[#E7EAF3] shadow-[0_10px_30px_rgba(15,23,42,0.05)] p-6">
            ...
            {allUpcoming.length > 0 ? (
              <div className="bg-[#F5F7FF] rounded-2xl px-5 py-4 border border-[#E7EAF3] flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-[#5B4FF7] hover:underline shrink-0"
                >
                  View all
                </button>
              </div>
          ...
          <div className="bg-white rounded-[28px] border border-[#E7EAF3] shadow-[0_10px_30px_rgba(15,23,42,0.05)] p-5 sm:p-6">
            <div className="flex items-center gap-2 mb-1">
              <div className="w-7 h-7 bg-[#F5F7FF] rounded-lg flex items-center justify-center">
                <Stethoscope size={15} className="text-[#5B4FF7]" />
              </div>
              <span className="font-semibold text-[#1F2937] text-sm">
            ...
            {consultCards.length === 0 ? (
              <div className="mt-4 bg-[#F6F8FC] rounded-2xl px-5 py-4 text-center border border-[#E7EAF3]">
                <p className="text-sm text-[#6B7280]">
              ...
              <>
                {bookableCount > 0 && (
                  <div className="mt-3 mb-4 rounded-2xl bg-gradient-to-r from-[#5B4FF7] to-[#4338CA] px-4 py-3 flex items-center gap-2 shadow-[0_6px_18px_rgba(91,79,247,0.25)]">
                        ...
                        {visibleCards.map((card) => {
                          ...
                          if (status === "available" && card.isBookableNow) {
                            return (
                              <button
                                ...
                                className={`${cardBase} text-left border-[#C7C2F5] bg-[#F5F7FF]/60 hover:bg-[#F5F7FF] consult-blink`}
                              >
                                <div className="flex items-center gap-3">
                                  <div className="w-10 h-10 rounded-xl bg-[#EEF2FF] flex items-center justify-center shrink-0">
                                    <Stethoscope size={16} className="text-[#5B4FF7]" />
                                  </div>
                                  <div className="min-w-0 flex-1">
                                    <p className="text-[13px] sm:text-sm font-bold text-[#1F2937] truncate">
                                      Free Consultation {card.cardIndex}
                                    </p>
                                    <p className="text-[11px] sm:text-xs text-[#5B4FF7] font-medium mt-0.5 truncate">
                                      Tap to book →
                                    </p>
                                  </div>
                                </div>
                          ...
                          if (status === "available" && !card.isBookableNow) {
                            return (
                              <div
                                key={card._id}
                                className={`${cardBase} border-dashed border-[#E7EAF3] bg-[#F6F8FC]/60 opacity-80`}
                              >
                                <div className="flex items-center gap-3">
                              ...
                              {canJoin && (
                                <div className="mt-3 pt-3 border-t border-emerald-100 space-y-2">
                                  <div className="flex items-center gap-1.5 text-[11px] text-gray-500">
                                    <Video size={12} className="text-[#5B4FF7] shrink-0" />
                                    <a
                                      href={appt.meetingLink}
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="text-[#5B4FF7] text-xs hover:underline truncate"
                                  ...
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-full inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-full text-xs font-semibold text-white bg-[#5B4FF7] hover:bg-[#4338CA] transition-colors shadow-[0_4px_10px_rgba(91,79,247,0.25)]"
                                  >
                                    <Video size={12} />
                                    Join Now
                                  </a>
                      ...
                      {sortedCards.length > 6 && (
                        <div className="flex justify-center mt-4">
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-5 py-2 rounded-full text-xs font-semibold text-[#5B4FF7] border border-[#C7C2F5] hover:bg-[#F5F7FF] transition-colors"
                          >
